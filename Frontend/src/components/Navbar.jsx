    ...
    <div className={`max-w-screen-2xl container mx-auto md:px-20 fixed top-0 left-0 right-0 z-50 ${
      ...
      <div className="navbar" role="navigation">
        <div className="navbar-start">
          ...
          <Link to="/" className="font-extrabold text-2xl cursor-pointer text-zinc-200">RIVA</Link>
        </div>
        <div className="navbar-end space-x-4">
          ...
          <div>
            <button
              className="bg-white text-black px-4 py-2 font-bold rounded-md mx-4 cursor-pointer"
